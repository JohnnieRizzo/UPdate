defmodule GratefulSetCrewWeb.UserAuthTest do
  ...
  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, GratefulSetCrewWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
